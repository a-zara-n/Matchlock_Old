...
var (
	...
	TestRequests = map[string]*Request{
		...
		TestCaseSlice[1]: {
			...
			String: "POST /testing/ HTTP/1.0\n" + strings.Join(TestHeaderSlice, "\n") + "\n\n" + TestQuery[TestCaseSlice[1]].Fetch,
			header: Testheaderstruct,
		...
		TestCaseSlice[2]: {
			...
			String: "POST /testing/ HTTP/1.0\n" + strings.Join(TestHeaderSlice, "\n") + "\n\n" + TestQuery[TestCaseSlice[2]].Fetch,
			header: Testheaderstruct,
		...
		TestCaseSlice[3]: {
			...
			String: "POST /testing/ HTTP/1.0\n" + strings.Join(TestHeaderSlice, "\n") + "\n\n" + TestQuery[TestCaseSlice[3]].Fetch,
			header: Testheaderstruct,
		...
		TestCaseSlice[4]: {
			...
			String: "GET /testing/ HTTP/1.0\n" + strings.Join(TestHeaderSlice, "\n") + "\n\n" + TestQuery[TestCaseSlice[4]].Fetch,
			header: Testheaderstruct,
